# DTA 250 &ndash; Fundamentals of Data Science and Analytics
...
5. Do all of 1-4 in the R statistical programming language.
...
We will use an online ZyBook covering statistics, analytics, and the R programming environment. The text includes built-in problems that you will complete along with the assigned homework projects. In most cases, the questions for each book chapter will be due at the same time as a programming project.

To access the text, create an account on the ZyBooks site, https://learn.zybooks.com. Enter the ZyBook code: ROLLINSDTA250MyersFall2020. The subscription is $88 and lasts until after the final exam.

We will use [R Studio](https://rstudio.com/) for our programming assignments and lab activities. R is the default statistical programming language and contains powerful built-in features to do pretty much everything we need to do in this course. R Studio is open source and free.
...
| 3            | Regression          |   10/14   |  10/28      | Long Bones  |
...
- You are not required to keep your webcam on during class, but please do so as much as possible; it helps when I can see everyone.
